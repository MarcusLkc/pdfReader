...
async function main() {
  ...
  const file = await openai.files.create({
      file: fs.createReadStream("TheRealEstateInvestor.pdf"),
      purpose: "assistants",
    });
    ...
    const assistant = await openai.beta.assistants.create({
      ...
      instructions:
        "You are a real estate advisor. Use your knowledge base to best respond to customer queries.",
    ...
    console.log(
      "\nHello there, I'm your personal real estate investment advisor. Ask some complicated questions.\n"
    );
